          ...
          {currentPage.letters.map((letter) => {
            ...
            return (
              <motion.button
                ...
                className={`relative w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl border-3 sm:border-4 flex items-center justify-center shadow-xl cursor-pointer transition-all duration-200 ${
                  isClicked
